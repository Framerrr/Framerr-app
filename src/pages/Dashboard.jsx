...
const Dashboard = () => {
    ...
    return (
        ...
        >
            ...
            {/* Bottom Spacer - On mobile: accounts for tab bar + comfortable gap. On desktop: just page margin */}
            <div style={{ height: isMobile ? LAYOUT.TABBAR_HEIGHT + (LAYOUT.PAGE_MARGIN * 2) : LAYOUT.PAGE_MARGIN }} aria-hidden="true" />
        </div>
    );
};
