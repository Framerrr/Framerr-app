                    ...
                    >
                        ...
                        <div className="flex gap-2 mt-3">
                            <div
                                ...
                                style={{ backgroundColor: t.id === 'light' ? '#0ea5e9' : t.id === 'nord' ? '#88c0d0' : t.id === 'catppuccin' ? '#89b4fa' : t.id === 'dracula' ? '#bd93f9' : '#3b82f6' }}
                            />
                            <div
                                className="w-8 h-8 rounded"
                                style={{ backgroundColor: t.id === 'light' ? '#10b981' : t.id === 'nord' ? '#a3be8c' : t.id === 'catppuccin' ? '#a6e3a1' : t.id === 'dracula' ? '#50fa7b' : '#10b981' }}
                            />
                            <div
                                className="w-8 h-8 rounded"
                                style={{ backgroundColor: t.id === 'light' ? '#f59e0b' : t.id === 'nord' ? '#ebcb8b' : t.id === 'catppuccin' ? '#f9e2af' : t.id === 'dracula' ? '#f1fa8c' : '#f59e0b' }}
                            />
                        </div>
                    </button>
                ))}
