...
import { Activity, Disc, Clock } from 'lucide-react';
...
const SystemStatusWidget = ({ config }) => {
    ...
    const getColor = (v) => {
        return v < 50 ? '#4caf50' : v < 75 ? '#ffc107' : '#f44336';
            ...
            const newChart = new window.Chart(canvasRef.current, {
                ...
                data: {
                    datasets: [{
                        ...
                        backgroundColor: 'rgba(108, 79, 143, 0.2)',
                ...
                {!enabled || !url ? (
                    <div style={{
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-theme-secondary text-center">
                            <div>
                                <Activity size={24} style={{ opacity: 0.5, marginBottom: '0.5rem' }} />
                                <Activity size={24} className="opacity-50 mb-2 mx-auto" />
                                <p>System Health Not Configured</p>
                                <p style={{ fontSize: '0.85rem', marginTop: '0.25rem' }}>Configure in Settings</p>
                        ...
                        <div style={{
                            ...
                            <div className="flex flex-col gap-3 p-3 h-full justify-around">
                                {/* CPU */}
                                <div onClick={() => openGraph('cpu')} style={{ cursor: 'pointer' }}>
                                        ...
                                        <span style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                                            <div onClick={() => openGraph('cpu')} className="cursor-pointer group">
                                                ...
                                                <div style={{ width: '100%', height: '6px', backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: '3px', overflow: 'hidden' }}>
                                                    <div style={{ width: `${statusData.cpu}%`, height: '100%', backgroundColor: getColor(statusData.cpu), borderRadius: '3px', transition: 'width 0.4s ease' }} />
                                                ...
                                                {/* Memory */}
                                                <div onClick={() => openGraph('memory')} style={{ cursor: 'pointer' }}>
                                                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.3rem', fontSize: '0.85rem' }}>
                                                        <span style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                                                            <div onClick={() => openGraph('memory')} className="cursor-pointer group">
                                                                ...
                                                                <div style={{ width: '100%', height: '6px', backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: '3px', overflow: 'hidden' }}>
                                                                    <div style={{ width: `${statusData.memory}%`, height: '100%', backgroundColor: getColor(statusData.memory), borderRadius: '3px', transition: 'width 0.4s ease' }} />
                                                                    <div className="w-full h-1.5 bg-theme-tertiary rounded-full overflow-hidden">
                                                                        <div
                                                                            style={{
                                                                ...
                                                                {/* Temperature */}
                                                                <div onClick={() => openGraph('temperature')} style={{ cursor: 'pointer' }}>
                                                                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.3rem', fontSize: '0.85rem' }}>
                                                                        <span style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                                                                            <div onClick={() => openGraph('temperature')} className="cursor-pointer group">
                                                                                ...
                                                                                <div style={{ width: '100%', height: '6px', backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: '3px', overflow: 'hidden' }}>
                                                                                    <div style={{ width: `${tempPct}%`, height: '100%', backgroundColor: getColor(tempPct), borderRadius: '3px', transition: 'width 0.4s ease' }} />
                                                                                    <div className="w-full h-1.5 bg-theme-tertiary rounded-full overflow-hidden">
                                                                                        <div
                                                                                            style={{
                                                                                                width: `${tempPct}%`,
