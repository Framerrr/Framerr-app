...
8. **Session length check:**
   ...
   - If tool calls >= 80: Strongly warn "Session at 80 tool calls. Recommend /end-session to maintain quality."
   - If tool calls >= 100: Alert "Session exceeded 100 tool calls. You should /end-session now."
