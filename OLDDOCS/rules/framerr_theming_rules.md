...
1. `docs/theme/DEVELOPER_GUIDE.md` - Core guidelines and patterns
2. `docs/theme/CSS_VARIABLES.md` - Available variables reference
3. `docs/theme/COMPONENT_PATTERNS.md` - Copy-paste patterns
...
### Common Patterns
See `docs/theme/COMPONENT_PATTERNS.md` for copy-paste ready examples:
...
- **Architecture**: `docs/theme/THEMING_ENGINE.md`
- **Developer Guide**: `docs/theme/DEVELOPER_GUIDE.md`
- **CSS Variables** (71 total): `docs/theme/CSS_VARIABLES.md`
- **Patterns**: `docs/theme/COMPONENT_PATTERNS.md`
- **Migration Guide**: `docs/theme/MIGRATION_GUIDE.md` (for reference)
